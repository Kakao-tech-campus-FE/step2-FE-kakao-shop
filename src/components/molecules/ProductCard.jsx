    ...
    return(
        <Card to={`/product/${product.id}`}>
            ...
            <div>
                ...
                <Product.PriceTextContainer><Product.TalkPriceText>톡딜가</Product.TalkPriceText><Product.PriceText>{comma(product.price)}원 부터~</Product.PriceText></Product.PriceTextContainer>
            </div>
        </Card>
    );
};
