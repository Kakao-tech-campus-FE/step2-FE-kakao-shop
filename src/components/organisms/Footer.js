...
export default function Footer() {
  return (
    <footer className="absolute bottom-0 w-full h-32 bg-gray-50 border flex items-center justify-center space-x-4">
      <ImageLink PhotoClassName="h-8" to="/" src={logoKakao} alt="logoKakao" />
      <p>
