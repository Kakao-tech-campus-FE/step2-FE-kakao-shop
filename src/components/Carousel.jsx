...
const Carousel = () => {
  ...
  React.useEffect(() => {
    dotRef.map((dotRef) => {dotRef.current.style.backgroundColor = "gray"})
    dotRef[currentIndex].current.style.backgroundColor = "black"
  }, [currentIndex])

  const handleLeftButton = () => {
    imgRef1.current.style.translate = "500px"
    imgRef2.current.style.translate = "500px"
    imgRef3.current.style.translate = "500px"
    setTimeout(() => {
