        ...
        <Order.Container>
            <Order.Box>
                ...
                <Order.CheckBoxContainer>
                    <Order.TotalAgree>
                        <input type="checkbox" id="all-agree" checked={agreePayment && agreePolicy} onChange={handleAllAgree}/>
                    ...
                    <div>
                        ...
                        <Order.PolicyText>
                            {'('}주{')'}카카오에서는 판매하는 상품 중에는 개별 판매자가 판매하는 상품이 포함되어 있습니다. 
                            개별 판매자가 판매하는 상품에 대해 {'('}주{')'}카카오는 통신중게 판매업자로서 통신판매의 당사자가 아니며 
                            상품의 주문, 배송 및 환불 등과 관련한 의무와 책임은 각 판매자에게 있습니다.
                
                        </Order.PolicyText>
                    </div>
                </Order.CheckBoxContainer>
                <Order.Button disabled={!agreePayment || !agreePolicy} onClick={() => {
                    // POST: /orders/save
