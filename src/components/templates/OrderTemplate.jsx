        ...
        <div className="py-20">
            <div className="block mx-auto max-w-[1024px] w-[100%]">
                ...
                <div className="border p-4 flex items-center justify-between">
                    ...
                    <span className="pric text-xl text-indigo-700">{comma(totalPrice)}원</span>
                </div>
                {/* 전체 동의, 구매조건 확인 및 결제 진행 동의 */}
                <div className="border flex flex-col p-4 gap-10">
                    ...
                    <button
                        ...
                        className={`w-full p-4 font-medium ${
                            allAgree ? 'bg-yellow-500 text-black' : 'bg-gray-300 text-gray-500'
                        }`}
                    >
                        결제하기
                    </button>
