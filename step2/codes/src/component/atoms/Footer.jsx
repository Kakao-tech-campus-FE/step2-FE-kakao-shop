            ...
            <div className="max-w-[1280px] py-10 m-auto  flex">
                ...
                <div className="pl-8">
                    <p>
                        ...
                        <span className="text-xs text-#a6a6a6">대표이사 : 홍은택</span>
                        <span className="text-xs text-#a6a6a6">주소 : 제주특별자치도 제주시 첨단로 242</span>
                    </p>
                    <p>
                        <span className="text-xs text-#a6a6a6">사업자등록번호 : 120-81-47521</span>
                        <span className="text-xs text-#a6a6a6">통신판매업신고 : 제2015 - 제주아라 - 0032호</span>
                        <span className="text-xs text-#a6a6a6">호스팅 사업자 : (주)카카오</span>
                    </p>
                    <p>
                        <span className="text-xs text-#a6a6a6">이메일 : cs.shopping@kakaocorp.com</span>
                        <span className="text-xs text-#a6a6a6">고객센터 : 1544-5664 (통화료 발생 / 평일 09:00~18:00)</span>
                    </p>
                    <p>
